        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mb-5">
                    ...
                    <h2 class="mt-2 mb-3" style={{fontSize: '40px', fontWeight: '800'}}>25 Years Expereince</h2>
                ...
                <div class="col-lg-6">
                    <div class="row">
                        ...
                        <div class="col-sm-6 pb-1">
                            <div class="d-flex flex-column align-items-center border px-4 mb-4">
                                <h2 class="display-3 mb-3" data-toggle="counter-up" style={{color:'#4267b2', fontWeight:'600'}}>1050</h2>
                                <h5 class="font-weight-bold mb-4">Happy Clients</h5>
                            </div>
                        </div>
                        <div class="col-sm-6 pb-1">
                            <div class="d-flex flex-column align-items-center border px-4 mb-4">
                                <h2 class="display-3 mb-3" data-toggle="counter-up" style={{color:'#4267b2', fontWeight:'600'}}>2500</h2>
