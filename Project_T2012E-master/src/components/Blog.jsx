      ...
      <div className="container-fluid pt-5">
        <div className="container">
            <div className="text-center">
                ...
                <h2 className="mt-2 mb-5" style={{color:'#4267b2'}}>Latest From Blog</h2>
            </div>
            <div className="row">
                <div className="col-md-6 mb-5">
                    <div className="position-relative">
                        <img style={{height:'400px'}} className="img-fluid w-100" src={blogs && blogs.length > 0 ? blogs[blogs.length-1].Thumbnail : ""} alt=""/>
                    ...
                    <div className="border border-top-0" style={{padding:'30'}}>
                        ...
                        <a className="h5 font-weight-bold" href="">{blogs && blogs.length > 0 ? blogs[blogs.length-1].Title : ""}</a>
                    </div>
                </div>
                <div className="col-md-6 mb-5">
                    <div className="position-relative">
                        <img style={{height:'400px'}} className="img-fluid w-100" src={blogs && blogs.length > 0 ? blogs[blogs.length-2].Thumbnail : ""} alt=""/>
                        <div className="position-absolute d-flex flex-column align-items-center justify-content-center"
                         //    style="width: 80px; height: 80px; bottom: 0; left: 0;"
                            style={{width: '80px', height: '80px', bottom: '0', left: '0', backgroundColor:'#4267b2'}}
                            >
                    ...
                    <div className="border border-top-0" style={{padding:'30'}}>
                        ...
                        <a className="h5 font-weight-bold" href="">{blogs && blogs.length > 0 ? blogs[blogs.length-2].Title : ""}</a>
                    </div>
                </div>
            </div>
        </div>
